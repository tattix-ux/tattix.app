  ...
  return (
    <AppShell>
      <Container className="overflow-x-clip py-4 sm:py-6 lg:px-6 xl:max-w-[1360px] xl:px-6 2xl:max-w-[1400px]">
        <header className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between sm:gap-3 xl:gap-3">
          <Logo iconSize="sm" wordmarkSize="sm" className="gap-2.5" />
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
            <div className="inline-flex w-full items-center justify-between gap-1.5 rounded-full border border-white/8 bg-white/[0.045] p-1 sm:w-auto sm:justify-start">
              <span className="px-2 text-[11px] font-medium tracking-[0.04em] text-white/60">
                {copy.languageLabel}
              </span>
        ...
        <section className="relative grid gap-5 py-8 sm:py-12 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:gap-7 xl:gap-8 xl:py-12">
          <BrandMonogram className="hidden lg:block lg:left-[10%] lg:top-8 lg:h-[280px] lg:w-[280px] xl:h-[300px] xl:w-[300px]" opacity={0.032} />
          <div className="space-y-3.5 sm:space-y-4 xl:space-y-3.5">
            <div className="max-w-[160px] sm:max-w-[190px] xl:max-w-[200px]">
              <BrandPrimary priority />
              <BrandWordmark className="mt-2.5 text-center text-[1rem] tracking-[0.4em] sm:text-[1.08rem]" />
            </div>
            <Badge
              variant="accent"
              className="max-w-fit whitespace-normal rounded-full px-3 py-1 text-center text-[10.5px] font-medium tracking-[0.04em] sm:text-left"
            >
              {copy.heroEyebrow}
            </Badge>
            <div className="space-y-2.5 sm:space-y-3 xl:space-y-2.5">
              <h1 className="max-w-[11ch] text-[2.2rem] font-semibold leading-[0.93] tracking-[-0.05em] text-white sm:text-[3.25rem] lg:text-[2.9rem] xl:text-[3.05rem] 2xl:text-[3.15rem]">
                {copy.heroTitle}
              </h1>
              <p className="max-w-[540px] text-[13.5px] leading-6 text-[var(--foreground-muted)] sm:text-[14.5px] sm:leading-6">
            ...
            <p className="text-[11.5px] leading-5 text-[var(--foreground-muted)] sm:text-[12px]">{copy.ctaNote}</p>
          </div>

          <Card className="surface-border overflow-hidden border-white/[0.07] bg-[linear-gradient(180deg,rgba(255,255,255,0.028),rgba(255,255,255,0.018))] shadow-[0_16px_40px_rgba(0,0,0,0.18)]">
            <CardContent className="space-y-3 p-4 sm:p-5 xl:space-y-3 xl:p-5">
              <Badge variant="muted" className="rounded-full px-3 py-1 text-[10.5px] font-medium tracking-[0.04em]">
                {copy.heroFormBadge}
              </Badge>
              <div className="rounded-[22px] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(255,255,255,0.038),rgba(255,255,255,0.018))] p-3.5 sm:p-4">
                <div className="space-y-2.5">
                  <div className="rounded-[18px] border border-white/[0.07] bg-black/18 p-3.5">
                  ...
                  <div className="rounded-[16px] border border-[var(--accent)]/12 bg-[var(--accent)]/[0.055] px-3.5 py-2.5 text-[12px] leading-5 text-white/80">
        ...
        <section className="grid gap-3 pb-8 sm:grid-cols-3 sm:pb-10 xl:pb-12">
          {copy.trustItems.map((item) => (
            <div
              key={item}
              className="flex min-h-[56px] items-center gap-2.5 rounded-[18px] border border-white/[0.07] bg-white/[0.025] px-4 py-3 text-[13px] text-white/84"
            >
          ...
          <div className="grid gap-3">
            {copy.problemList.map((item, index) => {
              ...
              return (
                <div
                  key={item}
                  className="flex items-center gap-3 rounded-[18px] border border-white/[0.07] bg-white/[0.025] px-4 py-3.5 text-white"
                >
        ...
        <section className="space-y-5 py-8 sm:space-y-6 sm:py-10 xl:py-12">
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            {copy.features.map((feature, index) => {
              ...
              return (
                <Card key={feature.title} className="surface-border border-white/[0.07]">
        ...
        <section className="py-8 sm:py-10 xl:py-12">
          <div className="grid gap-5 rounded-[26px] border border-[var(--accent)]/12 bg-[linear-gradient(180deg,rgba(247,177,93,0.06),rgba(255,255,255,0.018))] p-5 sm:p-6 lg:grid-cols-[1.02fr_0.98fr]">
            <div className="space-y-3">
            ...
            <div className="grid gap-3">
              {copy.positioningBullets.map((item) => (
                <div key={item} className="flex items-start gap-3 rounded-[18px] border border-white/[0.07] bg-black/16 p-3.5 text-[13.5px] text-white/88">
        ...
        <section className="grid gap-5 py-8 sm:py-10 lg:grid-cols-[1.02fr_0.98fr] lg:gap-7 xl:gap-8 xl:py-12">
          ...
          <div className="grid gap-3">
            {copy.pricingBullets.map((item) => (
              <div
                key={item}
                className="flex items-center gap-3 rounded-[18px] border border-white/[0.07] bg-white/[0.025] px-4 py-3 text-[13.5px] text-white/88"
              >
        ...
        <section className="space-y-5 py-8 sm:space-y-6 sm:py-10 xl:py-12">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {copy.steps.map((step, index) => (
              <Card key={step.title} className="surface-border border-white/[0.07]">
        ...
        <section className="py-8 sm:py-10 xl:py-12">
          <div className="rounded-[26px] border border-white/[0.07] bg-white/[0.025] p-5 text-center sm:p-7 xl:p-8">
