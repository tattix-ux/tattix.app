  ...
  return (
    <AppShell>
      <Container className="overflow-x-clip py-4 sm:py-5 lg:px-6 xl:max-w-[1440px] xl:px-6 2xl:max-w-[1480px]">
        ...
        <section className="grid gap-6 pt-6 pb-8 lg:grid-cols-[1fr_0.92fr] lg:items-center lg:gap-9 xl:gap-12 xl:pt-8 xl:pb-10">
          <div className="space-y-5">
            <div className="space-y-3">
              <h1 className="max-w-[10ch] text-[2.85rem] font-semibold leading-[0.9] tracking-[-0.055em] text-white sm:text-[3.55rem] lg:text-[3.4rem] xl:text-[3.85rem]">
                {copy.heroTitle}
              </h1>
              <p className="max-w-[600px] text-[14px] leading-[1.6] text-[var(--foreground-muted)] sm:text-[15px]">
                {copy.heroDescription}
              </p>
              <div className="max-w-[560px] rounded-[18px] border border-[var(--accent)]/16 bg-[var(--accent)]/[0.055] px-4 py-3 text-[13px] font-medium leading-[1.55] text-white/90">
                {copy.heroHighlight}
              </div>
            </div>
          ...
          <Card className="surface-border overflow-hidden border-white/[0.07] bg-[linear-gradient(180deg,rgba(255,255,255,0.022),rgba(255,255,255,0.012))] shadow-[0_18px_42px_rgba(0,0,0,0.18)]">
            <CardContent className="space-y-4 p-4 sm:p-5">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-[18px] border border-[var(--accent)]/12 bg-[var(--accent)]/[0.055] px-4 py-3 text-[12.5px] leading-[1.5] text-white/84 sm:col-span-2">
                  {copy.heroPreview.note}
                </div>
                <div className="flex items-center gap-2 rounded-[16px] border border-white/[0.08] bg-white/[0.025] px-4 py-3 text-[12.5px] text-white/82 sm:col-span-2">
