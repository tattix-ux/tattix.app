...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-[16px] text-[13px] font-medium leading-none transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] xl:rounded-[14px] xl:text-[12.5px]",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: "h-9 px-3.5 xl:h-[36px] xl:px-3",
        sm: "h-8 px-3 text-[12px] xl:h-[32px] xl:px-2.5 xl:text-[11.5px]",
        lg: "h-10 px-5 text-sm xl:h-[38px] xl:px-4 xl:text-[13px]",
        icon: "size-9 rounded-[15px] xl:size-[34px] xl:rounded-[12px]",
      },
    },
    defaultVariants: {
      variant: "default",
