...
const profileCopy = {
  en: {
    ...
    upload: "Upload image",
    remove: "Remove image",
    shortBio: "Short intro text",
    shortBioHelp: "Optional. A short line about your studio or style.",
  ...
  tr: {
    ...
    shortBio: "Kısa tanıtım metni",
    shortBioHelp: "İsteğe bağlı. Stilin veya stüdyon için kısa bir satır ekleyebilirsin.",
