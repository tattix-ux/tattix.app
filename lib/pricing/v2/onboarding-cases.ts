...
> = {
  text: {
    fit: "contain",
    frameClassName: "bg-white/[0.985] px-1.5 py-2.5",
    imageClassName: "scale-[1.74] object-center",
  },
  symbol: {
    fit: "contain",
    frameClassName: "bg-white/[0.985] px-1.5 py-1.5",
    imageClassName: "scale-[1.78] object-center",
  },
  singleObject: {
    fit: "contain",
    frameClassName: "bg-white/[0.985] px-0.5 py-0.5",
    imageClassName: "scale-[1.72] object-center",
  },
  singleFigure: {
    fit: "contain",
  ...
  ornamental: {
    fit: "contain",
    frameClassName: "bg-white/[0.985] px-0 py-0.5",
    imageClassName: "scale-[1.72] object-center",
  },
  colorPiece: {
    fit: "contain",
  ...
  broadAreaPortrait: {
    fit: "contain",
    sizeClassName: "h-[236px] md:h-[276px]",
    frameClassName: "bg-white/[0.985] px-1 py-1",
    imageClassName: "scale-[1.3] object-center",
  },
  broadAreaLandscape: {
    fit: "contain",
    sizeClassName: "h-[196px] md:h-[228px]",
    frameClassName: "bg-white/[0.985] px-1 py-1",
    imageClassName: "scale-[1.22] object-center",
  },
  broadAreaSquare: {
    fit: "contain",
    sizeClassName: "h-[218px] md:h-[254px]",
    frameClassName: "bg-white/[0.985] px-1.5 py-1.5",
    imageClassName: "scale-[1.34] object-center",
  },
};
