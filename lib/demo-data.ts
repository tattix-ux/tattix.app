  ...
  calibrationExamples: {
    ...
    pricingV2Profile: buildPricingV2Profile({
      ...
      onboardingCases: [
        ...
        { id: "advanced-realism-black-grey", min: 3800, max: 5400 },
...
export const demoLeads: ClientSubmission[] = [
  {
    ...
    largeAreaCoverage: null,
    wideAreaTarget: null,
    requestType: "single_object",
    estimateMode: "soft_range",
    featuredDesignPricingMode: null,
    displayEstimateLabel: "₺3.000 – ₺4.500",
  ...
  },
  {
    ...
    requestType: null,
    estimateMode: "range",
    featuredDesignPricingMode: "fixed_range",
    displayEstimateLabel: "₺1.600 – ₺2.450",
