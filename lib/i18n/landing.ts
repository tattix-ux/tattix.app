...
export const landingCopy = {
  tr: {
    login: "Giriş yap",
    languageLabel: "Dil",
    logoSubtitle: "Dövme talep ve fiyat akışı",
    ...
    heroFormBadge: "Müşteri sana yazmadan önce bunları doldurur",
    heroPreview: {
      requestLabel: "Talep türü",
      requestValue: "Özel dövme",
      budgetLabel: "Bütçe",
      budgetValue: "₺4.000 – ₺6.000",
      placementLabel: "Bölge",
      placementValue: "İç kol",
      sizeLabel: "Boyut",
      sizeValue: "Orta • 10–14 cm",
      designLabel: "Tasarım fikri",
      designValue: "İnce çizgili çiçek kompozisyonu",
      note: "Sana ulaşmadan önce temel bilgiler toparlanmış olur.",
    },
    trustItems: [
      "Profil sayfan müşteriye açık görünür",
      "Talep formu birkaç adımda doldurulur",
      "Fiyat tahmini senin ayarlarına göre hesaplanır",
    ],
    ...
    features: [
      {
        title: "Bilgiyi baştan toplarsın",
        description:
          "Müşteri bölgeyi, boyutu, referansını ve notlarını formda girer. Sonradan eksik bilgi kovalamazsın.",
      },
      {
    ...
    positioningBullets: [
      ...
      "Fiyat konuşması daha baştan çerçevelenir",
    ],
    ...
    pricingBullets: [
      ...
      "Pazarlık değil, ön çerçeve sunar",
      "Sürpriz talepleri azaltır",
    ],
    stepsTitle: "Nasıl çalışır?",
    steps: [
      {
        title: "Profil sayfanı oluştur",
        description: "Linkini Instagram profiline eklersin.",
      },
      {
        title: "Müşteri talep formunu doldurur",
        description: "Bölge, boyut, bütçe, tarih ve notlar birkaç adımda toplanır.",
      },
      {
        title: "Daha net talepler sana ulaşır",
        description: "Müşteri sana yazdığında temel çerçeve zaten oluşmuş olur.",
      },
    ],
  ...
  en: {
    ...
    logoSubtitle: "Tattoo request and pricing flow",
    ...
    heroFormBadge: "Clients fill these in before they message you",
    heroPreview: {
      requestLabel: "Request type",
      requestValue: "Custom tattoo",
      budgetLabel: "Budget",
      budgetValue: "$120 – $180",
      placementLabel: "Placement",
      placementValue: "Inner arm",
      sizeLabel: "Size",
      sizeValue: "Medium • 10–14 cm",
      designLabel: "Design idea",
      designValue: "Fine line floral composition",
      note: "The core details are already organized before they reach you.",
    },
    trustItems: [
      "Your profile page is visible to clients",
      "The request form is completed in a few steps",
      "The price estimate follows your settings",
    ],
    ...
    features: [
      {
        title: "You collect the basics upfront",
        description:
          "Clients enter placement, size, references, and notes in the form. You spend less time chasing missing details.",
      },
      {
    ...
    pricingBullets: [
      ...
      "Frames the conversation instead of bargaining",
      "Reduces surprise requests",
    ],
    stepsTitle: "How it works",
    steps: [
      {
        title: "Create your profile page",
        description: "Add the link to your Instagram profile.",
      },
      {
        title: "The client fills the request form",
        description: "Placement, size, budget, date, and notes are collected in a few steps.",
      },
      {
        title: "Clearer requests reach you",
        description: "When they message you, the basic frame is already there.",
      },
    ],
    finalTitle: "Start receiving more organized tattoo requests today",
    finalDescription: "Create your profile page, share your request form, and understand clients more clearly.",
    finalCta: "Create your profile page",
  },
} as const;
