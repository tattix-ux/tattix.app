...
export const publicCopy = {
  en: {
    ...
    customerDetailsTitle: "A few extra details",
    ...
    detailLevelHelp: "Choose the closest option.",
    detailLevels: {
      simple: "Low detail",
  ...
  tr: {
    ...
    customerDetailsTitle: "Birkaç ek bilgi",
    ...
    cityLabel: "Hangi şehirden randevu almak istersin?",
    cityHelp: "Sanatçının uygun olduğu şehirlerden birini seç.",
    cityPlaceholder: "Şehir seç",
    preferredTimingLabel: "Ne zaman düşünüyorsun?",
    preferredTimingHelp: "Sana en uygun zamanı seç.",
    ...
    detailLevelTitle: "Detay seviyesi",
    detailLevelHelp: "En yakın seçeneği seç.",
    detailLevels: {
      simple: "Daha sade",
      standard: "Orta detaylı",
      detailed: "Çok detaylı",
    },
    detailLevelDescriptions: {
      simple: "Az detay, basit ve ince çizgiler",
      standard: "Gölgelendirmeler ve daha detaylı görünümler",
      detailed: "Yoğun detay, gölge ya da daha gerçekçi görünümler",
    },
    colorModeTitle: "Renk",
    ...
    coverUpHelp: "Bu bilgi fiyatı etkileyebilir.",
    coverUpYes: "Evet, mevcut bir dövmenin üstüne",
    coverUpNo: "Hayır, yeni bir alan",
    optionalStyleTitle: "Yerleşim tarzı",
    optionalStyleHelp: "Tasarımın daha çok nasıl dursun?",
    ...
    summaryLabels: {
      ...
      preferredTiming: "Ne zaman düşünüyorsun?",
      notes: "Notlar",
      noNotes: "Ek not yok",
      estimatedPriceShown: "Müşteriye gösterilen tahmin",
    },
  },
} as const;
