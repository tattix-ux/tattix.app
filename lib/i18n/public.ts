...
export const publicCopy = {
  en: {
    ...
    stepDescriptions: [
      ...
      "Set the detail level, color direction, and whether it covers an older tattoo.",
    ...
    cityLabel: "Your city",
    cityHelp: "Optional, but useful for scheduling and studio planning.",
    cityPlaceholder: "Select your city",
    preferredTimingLabel: "Preferred timing",
    preferredTimingHelp: "Optional. Share your ideal start date or a small date range.",
    ...
    detailLevelHelp: "This directly affects the estimate range.",
    detailLevels: {
      simple: "Low detail",
    ...
    detailLevelDescriptions: {
      simple: "Cleaner shapes and lighter information density.",
      standard: "A balanced level for most tattoos.",
      detailed: "More texture, finer elements, and denser execution.",
    },
    colorModeTitle: "What color direction fits best?",
    colorModeHelp: "Color choice also changes the estimate range.",
    colorModes: {
    ...
    colorModeDescriptions: {
      ...
      "full-color": "Color is an active part of the final tattoo.",
    },
    ...
    optionalStyleTitle: "Optional style direction",
  ...
  tr: {
    ...
    stepDescriptions: [
      ...
      "Detay seviyesini, renk yönünü ve kapatma gerekip gerekmediğini seç.",
    ...
    notesHelper: "Bu bilgiler sanatçıya iletilecek ön mesaja eklenir.",
    cityLabel: "Bulunduğun şehir",
    cityHelp: "İsteğe bağlıdır, ama planlama ve randevu süreci için faydalı olur.",
    cityPlaceholder: "Şehrini seç",
    preferredTimingLabel: "Tercih edilen zaman",
    preferredTimingHelp: "İsteğe bağlı. Uygun olduğun başlangıç tarihini veya tarih aralığını paylaş.",
    preferredStartDate: "Tercih ettiğin başlangıç tarihi",
    preferredEndDate: "Tercih ettiğin bitiş tarihi",
    ...
    detailLevelHelp: "Bu seçim tahmini fiyat aralığını doğrudan etkiler.",
    detailLevels: {
      simple: "Az detay",
      standard: "Orta detay",
      detailed: "Çok detay",
    ...
    detailLevelDescriptions: {
      simple: "Daha temiz formlar ve daha hafif bir detay yoğunluğu.",
      standard: "Çoğu dövme için dengeli bir detay seviyesi.",
      detailed: "Daha fazla doku, ince öğe ve yoğun uygulama.",
    },
    colorModeTitle: "Renk yönü nasıl olsun?",
    colorModeHelp: "Renk seçimi de tahmini fiyatı etkiler.",
    colorModes: {
    ...
    colorModeDescriptions: {
      ...
      "full-color": "Renk, dövmenin aktif bir parçasıdır.",
    },
    ...
    optionalStyleTitle: "İsteğe bağlı stil yönü",
