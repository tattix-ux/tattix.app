...
export const publicCopy = {
  en: {
    ...
    stepDescriptions: [
      "Pick the request type and, if needed, choose a design.",
      "Choose the area first, then the exact spot.",
    ...
    placementCategoryHelp: "Pick the area first, then the exact spot.",
    ...
    notesPlaceholder: "Optional note (for example sensitivities or special situations)",
    notesHelper: "",
    contextTitle: "Extra context",
    contextHelp: "These details do not change the price, but they help the artist understand you better.",
    ...
    preferredTimingHelp: "Only available dates are shown.",
    ...
    calculatingBody: "We are preparing your estimate.",
  ...
  tr: {
    ...
    stepDescriptions: [
      "Talep türünü seç. İstersen hazır bir tasarım da seçebilirsin.",
      "Önce bölgeyi, sonra tam yerini seç.",
    ...
    placementCategoryHelp: "Önce bölgeyi, sonra tam yerini seç.",
    ...
    currentPlacementHelp: "Bölge değişirse alt seçim sıfırlanır.",
    selectPlacementFirst: "Önce yerleşim seç",
    selectPlacementHelp: "Boyutu seçmek için önce yerleşim belirle.",
    ...
    notesPlaceholder: "İstersen not ekleyebilirsin (ör. hassasiyetler, özel durumlar)",
    notesHelper: "",
    contextTitle: "Ek bağlam",
    contextHelp: "Bu bilgiler fiyatı değiştirmez, ama sanatçının seni daha iyi anlamasını sağlar.",
    cityLabel: "Randevu almak istediğin şehri seç.",
    cityHelp: "Randevu almak istediğin şehri seç.",
    cityPlaceholder: "Şehir seç",
    preferredTimingLabel: "Uygun randevu tarihi seç",
    preferredTimingHelp: "Sadece uygun tarihler gösterilir.",
    ...
    calculatingBody: "Tahminin hazırlanıyor.",
