...
export default async function DashboardLayout({
  ...
  return (
    <AppShell>
      <Container className="py-1.5 sm:py-2 lg:max-w-[1540px] 2xl:max-w-[1640px]">
        <div className="overflow-x-hidden pb-1 xl:pb-0">
          <div className="min-w-0">
            <div className="grid items-start gap-3 lg:grid-cols-[176px_minmax(0,1fr)] xl:gap-3.5">
              <aside className="w-full max-w-none space-y-2.5 lg:sticky lg:top-2 lg:max-w-[176px]">
                {dashboardData.demoMode ? <DemoModeBanner /> : null}
                <div className="relative flex flex-col overflow-hidden rounded-[20px] border border-[var(--border-soft)] bg-[linear-gradient(180deg,var(--surface-1)_0%,var(--bg-section)_100%)] px-2 py-2.5 shadow-[0_16px_34px_rgba(0,0,0,0.2)] lg:min-h-[calc(100vh-1rem)]">
                  <div className="space-y-3">
                    <Link href="/dashboard/profile" className="block text-center">
                      <div className="relative mx-auto size-[3.4rem] overflow-hidden rounded-full border border-[rgba(214,177,122,0.28)] bg-[radial-gradient(circle_at_50%_28%,rgba(255,255,255,0.05),rgba(255,255,255,0.012)_58%),linear-gradient(180deg,rgba(25,27,32,0.98),rgba(15,16,19,1))] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_10px_22px_rgba(0,0,0,0.22)]">
                        <Image
                      ...
                      <BrandWordmark size="sm" className="mt-2.5 text-center" />
                    </Link>
                    <div className="rounded-[15px] border border-white/5 bg-white/[0.02] px-2.5 py-2">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="truncate text-[13px] font-medium tracking-[-0.02em] text-white">
                      ...
                      {isProActive ? (
                        <Badge variant="accent" className="mt-1.5 rounded-full px-2.5 py-1 text-[9px]">
                  ...
                  <div className="mt-auto border-t border-[var(--border-soft)] pt-2.5">
