    ...
    <div className="mx-auto w-full max-w-[1240px] space-y-8">
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-start">
        <div className="grid gap-5 md:grid-cols-[160px_minmax(0,1fr)] md:items-center">
          <BrandPrimary className="mx-auto w-[132px] md:mx-0 md:w-[160px]" priority />
      ...
      <Card className="surface-border overflow-hidden border-[var(--border-soft)] bg-[linear-gradient(180deg,var(--surface-1)_0%,var(--bg-section)_100%)]">
        <CardContent className="p-0">
          <div className="grid divide-y divide-[var(--border-soft)] md:grid-cols-2 md:divide-x md:divide-y-0">
